    ...
    return function r(e, n, t) {
        ...
        "./lib/trianglify.js": [function (e, r) {
            function n(e) {
                ...
                function n(n, t) {
                    for (var f = [], o = -y; n + y > o; o += e.cell_size)for (var a = -v; t + v > a; a += e.cell_size) {
                        var i = o + e.cell_size / 2 + r(rand(), [0, 1], [-w, w]), c = a + e.cell_size / 2 + r(rand(), [0, 1], [-w, w]);
                ...
                if (e.color_function)s = function (r, n) {
                    ...
                    var l = o.scale(e.x_colors).mode(e.color_space), b = o.scale(e.y_colors).mode(e.color_space);
                    s = function (r, n) {
                ...
                for (var h = e.width, g = e.height, p = Math.floor((h + 4 * e.cell_size) / e.cell_size), m = Math.floor((g + 4 * e.cell_size) / e.cell_size), y = (p * e.cell_size - h) / 2, v = (m * e.cell_size - g) / 2, w = e.cell_size * e.variance / 2, x = function (e) {
                    ...
                    var N = [j[C], j[C + 1], j[C + 2]].map(q), U = a(N), A = s(x(U.x), _(U.y)).hex();
                    M.push([A, N])
                }
                return i(M, e)
            }

            var t = e("delaunay-fast"), f = e("seedrandom"), o = e("chroma-js"), a = e("./colorbrewer"), i = e("./pattern"), c = {
                width: 600,
                height: 400,
                cell_size: 75,
                variance: .75,
            ...
            (function (n) {
                function t(r, t) {
                    function o() {
                        ...
                        return e.setAttribute("width", t.width), e.setAttribute("height", t.height), r.forEach(function (r) {
                            var n = f.createElementNS("http://www.w3.org/2000/svg", "path");
                            n.setAttribute("d", "M" + r[1].join("L") + "Z"), n.setAttribute("fill", r[0]), n.setAttribute("stroke", r[0]), n.setAttribute("stroke-width", t.stroke_width), e.appendChild(n)
                        }), e
                    }
            ...
            (function () {
                ...
                l = function (e, n, t, f) {
                    ...
                    function e() {
                        ...
                        if (0 === n.length)s = [255, 0, 255, 1, "rgb"], a = s[0], i = s[1], c = s[2], e = s[3], t = s[4]; else if ("array" === R(n[0])) {
                            if (3 === n[0].length)l = n[0], a = l[0], i = l[1], c = l[2], e = 1; else {
                    ...
                    return e.prototype.rgb = function () {
                        ...
                        var e, r;
                        e = this.hex();
                        for (r in l.colors)if (e === l.colors[r])return r;
                        return e
                    ...
                    if (t = e.match(/rgb\(\s*(\-?\d+),\s*(\-?\d+)\s*,\s*(\-?\d+)\s*\)/)) {
                        ...
                        f[3] = 1
                    } else if (t = e.match(/rgba\(\s*(\-?\d+),\s*(\-?\d+)\s*,\s*(\-?\d+)\s*,\s*([01]|[01]?\.\d+)\)/))for (f = t.slice(1, 5), n = a = 0; 3 >= a; n = ++a)f[n] = +f[n]; else if (t = e.match(/rgb\(\s*(\-?\d+(?:\.\d+)?)%,\s*(\-?\d+(?:\.\d+)?)%\s*,\s*(\-?\d+(?:\.\d+)?)%\s*\)/)) {
                    ...
                    if (l = S(arguments), t = l[0], i = l[1], o = l[2], 0 === i)a = n = e = 255 * o; else {
                    ...
                    if (s = S(arguments), t = s[0], c = s[1], d = s[2], d *= 255, 0 === c)i = n = e = d; else switch (360 === t && (t = 0), t > 360 && (t -= 360), 0 > t && (t += 360), t /= 60, f = Math.floor(t), r = t - f, o = d * (1 - c), a = d * (1 - c * r), u = d * (1 - c * (1 - r)), f) {
                        case 0:
                    ...
                    return y = "rgb", v = l("#ccc"), k = 0, g = !1, h = [0, 1], s = [], x = !1, _ = [], m = 0, p = 1, b = !1, w = 0, d = {}, i = function (e, r) {
                        ...
                        if (null == e && (e = ["#ddd", "#222"]), null != e && "string" === R(e) && null != (null != (i = l.brewer) ? i[e] : void 0) && (e = l.brewer[e]), "array" === R(e)) {
                            ...
                            if (null != r)_ = r; else for (_ = [], n = o = 0, u = e.length - 1; u >= 0 ? u >= o : o >= u; n = u >= 0 ? ++o : --o)_.push(n / (e.length - 1))
                        }
                        return a(), s = e
                    }, c = function (e) {
                        ...
                        if (r ? b = e : h.length > 2 ? (n = f(e), b = n / (w - 1)) : (b = o = m !== p ? (e - m) / (p - m) : 0, b = o = (e - m) / (p - m), b = Math.min(1, Math.max(0, b))), r || (b = u(b)), i = Math.floor(1e4 * b), d[i])t = d[i]; else {
                            if ("array" === R(s))for (a = g = 0, x = _.length - 1; x >= 0 ? x >= g : g >= x; a = x >= 0 ? ++g : --g) {
                                if (c = _[a], c >= b) {
                                    t = s[a];
                                    break
                                }
                        ...
                        var n, f, o, a, i, c;
                        if (null == r && (r = "hex"), e = [], f = [], h.length > 2)for (n = o = 1, c = h.length; c >= 1 ? c > o : o > c; n = c >= 1 ? ++o : --o)f.push(.5 * (h[n - 1] + h[n])); else f = h;
                    ...
                    if (o = {
                        ...
                        }, "array" === R(e))for (c = 0, u = e.length; u > c; c++)a = e[c], i(a); else for (f in e)a = e[f], i(a, f);
                    ...
                    if (null == r && (r = "equal"), null == n && (n = 7), "array" === R(e) && (e = l.analyze(e)), p = e.min, h = e.max, q = e.sum, U = e.values.sort(function (e, r) {
                        ...
                        for (o.push(h); M;) {
                            ...
                            for (M = !1, d = nr = 0, F = n - 1; F >= 0 ? F >= nr : nr >= F; d = F >= 0 ? ++nr : --nr)if (x[d] !== o[u]) {
                                M = !0;
                                break
                            }
                            o = x, w++, w > 200 && (M = !1)
        ...
        "/Users/qrohlf/Code/trianglify/node_modules/delaunay-fast/delaunay.js": [function (e, r) {
            ...
            !function () {
                ...
                function e(e) {
                    ...
                    return n = u - i, t = d - c, f = Math.max(n, t), o = i + .5 * n, a = c + .5 * t, [[o - 20 * f, a - f], [o, a + 20 * f], [o + 20 * f, a - f]]
                }
                ...
                function f(e) {
                    var r, n, t, f, o, a;
                    for (n = e.length; n;)for (f = e[--n], t = e[--n], r = n; r;)if (a = e[--r], o = e[--r], t === o && f === a || t === a && f === o) {
                ...
                n = {
                    triangulate: function (r, n) {
                        ...
                        if (3 > y)return [];
                        if (r = r.slice(0), n)for (a = y; a--;)r[a] = r[a][n];
                        ...
                        var n = e[1][0] - e[0][0], t = e[2][0] - e[0][0], f = e[1][1] - e[0][1], o = e[2][1] - e[0][1], a = n * o - t * f;
                        if (0 === a)return null;
                        var i = (o * (r[0] - e[0][0]) - t * (r[1] - e[0][1])) / a, c = (n * (r[1] - e[0][1]) - f * (r[0] - e[0][0])) / a;
        ...
        "/Users/qrohlf/Code/trianglify/node_modules/seedrandom/index.js": [function (e, r) {
            var n = e("./lib/alea"), t = e("./lib/xor128"), f = e("./lib/xorwow"), o = e("./lib/xorshift7"), a = e("./lib/xor4096"), i = e("./lib/tychei"), c = e("./seedrandom");
        ...
        "/Users/qrohlf/Code/trianglify/node_modules/seedrandom/lib/alea.js": [function (r, n) {
            !function (e, r, n) {
                ...
                function o(e, r) {
                    var n = new t(e), o = r && r.state, a = n.next;
        ...
        "/Users/qrohlf/Code/trianglify/node_modules/seedrandom/lib/tychei.js": [function (r, n) {
            !function (e, r, n) {
                ...
                function o(e, r) {
                    var n = new t(e), o = r && r.state, a = function () {
                        return (n.next() >>> 0) / 4294967296
                    };
                    return a.double = function () {
                        do var e = n.next() >>> 11, r = (n.next() >>> 0) / 4294967296, t = (e + r) / (1 << 21); while (0 === t);
                        return t
        ...
        "/Users/qrohlf/Code/trianglify/node_modules/seedrandom/lib/xorshift7.js": [function (r, n) {
            !function (e, r, n) {
                function t(e) {
                    function r(e, r) {
                        var n, t, f = [];
                        if (r === (0 | r))t = f[0] = r; else for (r = "" + r, n = 0; n < r.length; ++n)f[7 & n] = f[7 & n] << 15 ^ r.charCodeAt(n) + f[n + 1 & 7] << 13;
        ...
        "/Users/qrohlf/Code/trianglify/node_modules/seedrandom/seedrandom.js": [function (r, n) {
            !function (t, f) {
                function o(e, r, n) {
                    var o = [];
                    r = 1 == r ? {entropy: !0} : r || {};
                    var l = u(c(r.entropy ? [e, s(t)] : null == e ? d() : e, 3), o), b = new a(o), p = function () {
                ...
                function d() {
                    try {
                        ...
                        var n = b.navigator, f = n && n.plugins;
