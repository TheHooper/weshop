!function (e) {
    ...
    "use strict";
    var r = e.fn.dataTable, s = function (t, n) {
        if (!r.versionCheck || !r.versionCheck("1.10.3"))throw"DataTables Responsive requires DataTables 1.10.3 or newer";
        this.s = {
            dt: new r.Api(t),
            columns: [],
            current: []
        }, this.s.dt.settings()[0].responsive || (n && "string" == typeof n.details ? n.details = {type: n.details} : n && n.details === !1 ? n.details = {type: !1} : n && n.details === !0 && (n.details = {type: "inline"}), this.c = e.extend(!0, {}, s.defaults, r.defaults.responsive, n), t.responsive = this, this._constructor())
    };
    e.extend(s.prototype, {
        _constructor: function () {
            var n = this, i = this.s.dt, s = i.settings()[0], o = e(t).width();
            ...
            var l = r.settings()[0].oScroll, c = l.sY || l.sX ? l.iBarWidth : 0, u = r.table().container().offsetWidth - c, h = u - d;
            ...
            var m = !1;
            for (n = 0, i = s.length; i > n; n++)if (!s[n].control && !s[n].never && !a[n]) {
                m = !0;
                break
            }
            ...
            var t = this, n = this.c.breakpoints, r = this.s.dt, s = r.columns().eq(0).map(function (t) {
                var n = this.column(t), s = n.header().className, o = r.settings()[0].aoColumns[t].responsivePriority;
                if (o === i) {
                ...
                var d, l, c;
                if (r) {
                    if ("max-" === r)for (d = t._find(i).width, l = 0, c = n.length; c > l; l++)n[l].width <= d && o(e, n[l].name); else if ("min-" === r)for (d = t._find(i).width, l = 0, c = n.length; c > l; l++)n[l].width >= d && o(e, n[l].name); else if ("not-" === r)for (l = 0, c = n.length; c > l; l++)-1 === n[l].name.indexOf(a) && o(e, n[l].name)
            ...
            s.each(function (t, i) {
                for (var r = t.className.split(" "), s = !1, o = 0, d = r.length; d > o; o++) {
                    ...
                    e.each(n, function (e, t) {
                        var n = t.name.split("-"), r = new RegExp("(min\\-|max\\-|not\\-)?(" + n[0] + ")(\\-[_a-zA-Z0-9])?"), o = l.match(r);
            ...
            for (var t = this.c.breakpoints, n = 0, i = t.length; i > n; n++)if (t[n].name === e)return t[n]
            ...
            var n, i, r = this, s = this.s.dt, o = e(t).width(), a = this.c.breakpoints, d = a[0].name, l = this.s.columns, c = this.s.current.slice();
            ...
            this.s.current = u;
            var h = !1;
            for (n = 0, i = l.length; i > n; n++)if (u[n] === !1 && !l[n].never && !l[n].control) {
                h = !0;
                break
            }
            ...
            if (this.c.auto && -1 !== e.inArray(!0, e.map(n, function (e) {
                ...
                var i = (t.table().node().offsetWidth, t.columns, t.table().node().cloneNode(!1)), r = e(t.table().header().cloneNode(!1)).appendTo(i), s = e(t.table().body()).clone(!1, !1).empty().appendTo(i), o = t.columns().header().filter(function (e) {
                    return t.column(e).visible()
                }).to$().clone(!1).css("display", "table-cell");
                e(s).append(e(t.rows({page: "current"}).nodes()).clone(!1)).find("th, td").css("display", "");
                var a = t.table().footer();
                if (a) {
                    var d = e(a.cloneNode(!1)).appendTo(i), l = t.columns().header().filter(function (e) {
                        return t.column(e).visible()
                    }).to$().clone(!1).css("display", "table-cell");
                    e("<tr/>").append(l).appendTo(d)
                }
                e("<tr/>").append(o).appendTo(r), "inline" === this.c.details.type && e(i).addClass("dtr-inline collapsed");
                var c = e("<div/>").css({width: 1, height: 1, overflow: "hidden"}).append(i);
                c.insertBefore(t.table().node()), o.each(function (e) {
            ...
            var t = this.s.dt, n = t.cells({page: "current"}).nodes().to$(), i = t.settings()[0], r = this.c.details.target;
            n.filter("[data-dtr-keyboard]").removeData("[data-dtr-keyboard]");
            var s = "number" == typeof r ? ":eq(" + r + ")" : r;
            e(s, t.rows({page: "current"}).nodes()).attr("tabIndex", i.iTabIndex).data("dtr-keyboard", 1)
        }
        ...
        childRow: function (t, n, i) {
            ...
            return function (i, r, s) {
                if (r)e("div.dtr-modal-content").empty().append(s()); else {
                    var o = function () {
        ...
        auto: !0,
        details: {
            display: s.display.childRow, renderer: function (t, n, i) {
    ...
    return o.register("responsive()", function () {
        ...
        return t = e(t), {column: t.data("dtr-index"), row: t.parent().data("dtr-index")}
    ...
    }), s.version = "2.0.2", e.fn.dataTable.Responsive = s, e.fn.DataTable.Responsive = s, e(n).on("preInit.dt.dtr", function (t, n, i) {
