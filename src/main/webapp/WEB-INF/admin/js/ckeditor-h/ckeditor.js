...
(function () {
    ...
    (function () {
        ...
        function r(a, h) {
            var b = a.getComputedStyle("border-" + h + "-width"), d = {thin: "0px", medium: "1px", thick: "2px"};
            0 > b.indexOf("px") && (b = b in d && "none" != a.getComputedStyle("border-style") ? d[b] : 0);
            return parseInt(b, 10)
        }

        function A(a) {
            var h = [], b = -1, d = "rtl" == a.getComputedStyle("direction"), f;
            f = a.$.rows;
            ...
            for (e = f.cells.length; c < e; c++) {
                var k = new CKEDITOR.dom.element(f.cells[c]), t = f.cells[c + 1] && new CKEDITOR.dom.element(f.cells[c + 1]), b = b + (k.$.colSpan || 1), n, l, p = k.getDocumentPosition().x;
                ...
                k = Math.max(l - n, 3);
                h.push({table: a, index: b, x: n, y: g.y, width: k, height: m.$.offsetHeight, rtl: d})
            }
            return h
        }
        ...
        function E(a) {
            ...
            function d(w) {
                ...
                for (var d = CKEDITOR.tools.buildTableMap(g.table), b = [], h = [], l = Number.MAX_VALUE, r = l, x = g.rtl, v = 0, A = d.length; v < A; v++) {
                    var q = d[v], u = q[w + (x ? 1 : 0)], q = q[w + (x ? 0 : 1)], u = u && new CKEDITOR.dom.element(u), q = q && new CKEDITOR.dom.element(q);
        ...
        var l =
            CKEDITOR.tools.cssLength, x = CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks);
                ...
                a.on("contentDom", function () {
                    ...
                    b.attachListener(b.isInline() ? b : a.document, "mousemove", function (d) {
                        ...
                        if (f.type == CKEDITOR.NODE_ELEMENT) {
                            ...
                            if (h && h.move(b))z(d); else if (f.is("table") || f.getAscendant("tbody", 1))if (f = f.getAscendant("table", 1), a.editable().contains(f)) {
                                (d =
    ...
    CKEDITOR.plugins.add("bt_table", {
        requires: "dialog,table", init: function (a) {
            function c(a) {
                return CKEDITOR.tools.extend(a || {}, {
                    contextSensitive: 1, refresh: function (a, d) {
                        this.setState(d.contains("table", 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED)
                    }
                })
            }
            ...
            if (!a.blockless) {
                var b = a.lang.table;
                a.addCommand("bt_table", new CKEDITOR.dialogCommand("bt_table", {
                    context: "table",
                    allowedContent: "table{width,height}[align,border,cellpadding,cellspacing,summary];caption tbody thead tfoot;th td tr[scope];" + (a.plugins.dialogadvtab ?
                    "table" + a.plugins.dialogadvtab.allowedContent() : ""),
                    requiredContent: "table",
                ...
                a.addCommand("bt_tableProperties", new CKEDITOR.dialogCommand("bt_tableProperties", c()));
                ...
                a.addMenuItems && a.addMenuItems({
                    table: {
                        label: b.menu,
                        command: "bt_tableProperties", group: "table", order: 5
                    }
                });
                a.on("doubleclick", function (a) {
                    a.data.element.is("table") && (a.data.dialog = "bt_tableProperties")
                });
                a.contextMenu && a.contextMenu.addListener(function () {
                    return {bt_table: CKEDITOR.TRISTATE_OFF}
                })
            }
        }
    });
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,a11yhelp,basicstyles,blockquote,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,tableresize,font,pbckcode,bt_table,justify,panelbutton,colorbutton,colordialog';
