    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">成交额统计-商品</strong> /
                    <small>Sum By Goods</small>
                </div>
            </div>
                ...
                <div class="am-u-sm-12">
                    <table id="table" class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <th data-field="typeName" class="table-type">成交额</th>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
                ...
                success: function (data) {
                    var table = $('#table').DataTable({
                        ...
                        "columnDefs": [
                            ...
                            {
                                "render": function (data, type, row, meta) {
                                    return '<a class="am-badge am-badge-secondary">&yen;' + data + '</a>'
                                },
                                "targets": 3
                            }
                        ],
