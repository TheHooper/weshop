...
<head>
    ...
    <link href="<c:url value="${pageContext.request.contextPath}/css/rating.css"/>" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="<c:url value="${pageContext.request.contextPath}/js/util/rating.js"/>"></script>
<script type="text/javascript">
    (function () {
